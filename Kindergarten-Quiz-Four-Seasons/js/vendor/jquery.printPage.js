...
(function ($) {
    ...
    $.fn.printPage = function (options) {
        ...
        var pluginOptions = {
            ...
            components = {
                iframe: function (url) {
                    return '<iframe id="printPage' + pluginOptions.id + '" name="printPage' + pluginOptions.id + '" src=' + url + ' style="position: absolute; top: -1000px; width: 100%; @media print { display: block;}"></iframe>';
                },
        ...
        function getURL(el, pluginOptions) {
            if ($.isFunction(pluginOptions.urlCallBack)) {
                ...
                return (pluginOptions.url) || $(el).attr(pluginOptions.attr);
            }
        }
        ...
        function addIframeToPage(el, pluginOptions) {
            ...
            pluginOptions.id = pluginOptions.id || $(el).attr('id');
            if (!pluginOptions.id) {
                pluginOptions.id = '';
            }
